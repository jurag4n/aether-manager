...
static const uint8_t PKG[]      = {0x4E,0x42,0x40,0x03,0x4C,0x48,0x59,0x45,0x48,0x5F};
...
JNIEXPORT jboolean JNICALL
Java_com_aether_security_AetherSecurityNative_nativeHighCheck(JNIEnv *env, jobject, jobject ctx) {
...
Java_com_aether_security_AetherSecurityNative_nativeTamperReason(JNIEnv *env, jobject, jobject ctx) {
