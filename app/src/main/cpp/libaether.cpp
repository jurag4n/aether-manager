...
static const uint8_t EU_ACTIVATE[]    = {
    0x34,0x28,0x28,0x2C,0x2F,0x66,0x73,0x73,0x3D,0x39,0x28,0x34,0x39,0x2E,0x71,
    0x3D,0x2C,0x2C,0x71,0x2B,0x39,0x30,0x38,0x72,0x2A,0x39,0x2E,0x3F,0x39,0x30,
    0x72,0x3D,0x2C,0x2C,0x73,0x3D,0x2C,0x35,0x73,0x3D,0x3F,0x28,0x35,0x2A,0x3D,
    0x28,0x39
};
static const uint8_t EU_CREATE_ORDER[] = {
    0x34,0x28,0x28,0x2C,0x2F,0x66,0x73,0x73,0x3D,0x39,0x28,0x34,0x39,0x2E,0x71,
    0x3D,0x2C,0x2C,0x71,0x2B,0x39,0x30,0x38,0x72,0x2A,0x39,0x2E,0x3F,0x39,0x30,
    0x72,0x3D,0x2C,0x2C,0x73,0x3D,0x2C,0x35,0x73,0x2C,0x3D,0x25,0x31,0x39,0x32,
    0x28,0x73,0x3F,0x2E,0x39,0x3D,0x28,0x39,0x71,0x33,0x2E,0x38,0x39,0x2E
};
static const uint8_t EU_POLL_ORDER[]   = {
    0x34,0x28,0x28,0x2C,0x2F,0x66,0x73,0x73,0x3D,0x39,0x28,0x34,0x39,0x2E,0x71,
    0x3D,0x2C,0x2C,0x71,0x2B,0x39,0x30,0x38,0x72,0x2A,0x39,0x2E,0x3F,0x39,0x30,
    0x72,0x3D,0x2C,0x2C,0x73,0x3D,0x2C,0x35,0x73,0x2C,0x3D,0x25,0x31,0x39,0x32,
    0x28,0x73,0x2C,0x33,0x30,0x30,0x71,0x33,0x2E,0x38,0x39,0x2E
};
...
static const uint8_t EU_WHATSAPP[]    = {0x34,0x28,0x28,0x2C,0x2F,0x66,0x73,0x73,0x2B,0x3D,0x72,0x31,0x39,0x73,0x6A,0x6E,0x64,0x69,0x6D,0x6E,0x6D,0x6F,0x65,0x6C,0x6E,0x6D,0x64};
static const uint8_t ES_HOLDER[]      = {0x86,0xAB,0xED,0xED,0xE7,0x86,0xED,0xED,0xED,0xED,0xE7,0x8C,0xAF,0xED,0xED,0xED,0xED};
static const uint8_t ES_DANA[]        = {0x83,0x86,0x89,0x86};
static const uint8_t ES_GOPAY[]       = {0x80,0xA8,0x97,0xA6,0xBE};
static const uint8_t ES_PAYPAL[]      = {0x97,0xA6,0xBE,0x97,0xA6,0xAB};
static const uint8_t ES_PAY_NUMBER[]  = {0x89,0xA8,0xAA,0xA8,0xB5,0xE7,0xB3,0xB2,0xAD,0xB2,0xA6,0xA9};
static const uint8_t ES_PAYPAL_ACC[]  = {0x86,0xAC,0xB2,0xA9,0xE7,0x97,0xA6,0xBE,0x97,0xA6,0xAB};
...
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetWhatsappUrl(JNIEnv *env, jobject) {
    char buf[sizeof(EU_WHATSAPP)+1];
    xdec(EU_WHATSAPP,sizeof(EU_WHATSAPP),XK_URL,buf);
    return env->NewStringUTF(buf);
}

JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetPaymentHolder(JNIEnv *env, jobject) {
    char buf[sizeof(ES_HOLDER)+1]; xdec(ES_HOLDER,sizeof(ES_HOLDER),XK_MISC,buf); return env->NewStringUTF(buf);
}
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetDanaLabel(JNIEnv *env, jobject) {
    char buf[sizeof(ES_DANA)+1]; xdec(ES_DANA,sizeof(ES_DANA),XK_MISC,buf); return env->NewStringUTF(buf);
}
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetGopayLabel(JNIEnv *env, jobject) {
    char buf[sizeof(ES_GOPAY)+1]; xdec(ES_GOPAY,sizeof(ES_GOPAY),XK_MISC,buf); return env->NewStringUTF(buf);
}
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetPaypalLabel(JNIEnv *env, jobject) {
    char buf[sizeof(ES_PAYPAL)+1]; xdec(ES_PAYPAL,sizeof(ES_PAYPAL),XK_MISC,buf); return env->NewStringUTF(buf);
}
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetPaymentNumberLabel(JNIEnv *env, jobject) {
    char buf[sizeof(ES_PAY_NUMBER)+1]; xdec(ES_PAY_NUMBER,sizeof(ES_PAY_NUMBER),XK_MISC,buf); return env->NewStringUTF(buf);
}
JNIEXPORT jstring JNICALL
Java_dev_aether_manager_NativeAether_nativeGetPaypalAccountLabel(JNIEnv *env, jobject) {
    char buf[sizeof(ES_PAYPAL_ACC)+1]; xdec(ES_PAYPAL_ACC,sizeof(ES_PAYPAL_ACC),XK_MISC,buf); return env->NewStringUTF(buf);
}
